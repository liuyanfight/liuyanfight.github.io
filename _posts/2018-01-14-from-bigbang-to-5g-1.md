---
layout: post
title: "Form BigBang to 5G 序章:物理层先验概念"
...
子载波间隔(SCS, sub-carrier spacing):![1529550290897](../img/blog/20180114/1529550290897.png), N的范围从0到5.

Note: the dedicated SCS for nominal and SS block(30kHz) are different `TODO: ????什么意思？`
...
5G NR最大
 ...
 ![5G NR Sample time unit](../img/blog/20180114/1529569089912.png)

#### 帧结构

无线帧(Radio frame) (10ms): ![Radio frame](../img/blog/20180114/1529569562700.png)
...
4G中子载波间隔是固定为15Khz的，但是由于5G在高频，可使用的带宽很大，所以引入了一个新名词：numerology（通信系统所用的一套参数，包括子载波间隔，符号长度，CP长度等等 ）。5G中，子载波间隔不像4G时代固定为15Khz，而是可变的，但一个RB还是12个子载波。
...
![img](http://sharetechnote.com/html/5G/image/NR_Numerology_SlotLength_38_211_v2_0_0_01.png)

### 天线端口 antenna port ject
